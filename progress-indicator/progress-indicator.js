(function() {
    ...
    Pproto.constructor = ProgressIndicator;
    ...
    Pproto.createIndicator = function() {
    ...
    Pproto.calculateWidthPrecent = function() {
    ...
    Pproto.setWidth = function(perc) {
        this.element.style.width = perc * 100 + '%';

    };

    Pproto.bindScrollEvent = function() {
        var self = this;
        var prev;
